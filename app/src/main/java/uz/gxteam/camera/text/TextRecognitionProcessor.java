...
import uz.gxteam.camera.other.FrameMetadata;
...
public class TextRecognitionProcessor {
    ...
    public String scannedTextBuffer;

    private DocType docType;

    public static final String TYPE_PASSPORT = "P<";

    public static final String TYPE_ID_CARD = "IU";
        ...
        if(docType == DocType.ID_CARD) {
            ...
            if(matcherIDCardTD1Line1.find() && matcherIDCardTD1Line2.find()) {
                ...
                if (line1.indexOf(TYPE_ID_CARD) >= 0) {
                    String lineText = line1.substring(line2.length()-16,line2.length()-2);
                    Log.e("Pinfl:", lineText);
                    ...
                    MRZInfo mrzInfo = buildTempMrz(documentNumber, dateOfBirthDay, expiryDate,lineText);
            ...
            if(matcherPassportTD3Line1.find() && matcherPassportTD3Line2.find()) {
                ...
                String lineText = line2.substring(line2.length()-16,line2.length()-2);
                Log.e("Pinfl:", lineText);
    ...
    private MRZInfo buildTempMrz(String documentNumber, String dateOfBirth, String expiryDate,String pinfl) {
        MRZInfo mrzInfo = null;
        try {
            mrzInfo = new MRZInfo("P","NNN", "", "", documentNumber, "NNN", dateOfBirth, Gender.UNSPECIFIED, expiryDate, pinfl);
        } catch (Exception e) {
